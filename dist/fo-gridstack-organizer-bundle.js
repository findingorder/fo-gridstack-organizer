...
var FoGridstackItem = {
    ...
    template: `
     ...
     v-bind:id='id'
     v-bind:data-gs-x='dataGsX' 
     v-bind:data-gs-y='dataGsY' 
     v-bind:data-gs-width='dataGsWidth' 
     v-bind:data-gs-height='dataGsHeight'
     style='overflow: hidden;'
>
    <div class='grid-stack-item-content' ref='gridstackItemContent'
        v-bind:id='contentId'
        style='overflow: hidden;'
    >
        {{ content }}
...
var css$1 = "\n/* TODO: Parameterize the spacing between items, then programatically set #border's padding to match. */\n\n/* #border's only purpose is to make the outside frame the same width as the separation between items. */\n\n#border {\n    margin: 0;\n    padding-top: 16px;\n    padding-bottom: 16px;\n    padding-left: 8px;\n    padding-right: 8px;\n\n    background-color: transparent;\n}";
styleInject(css$1);

// console.info('fo-gridstack-organizer.js: Start')

var foGridstackOrganizerMerged = {
...
export default foGridstackOrganizerMerged;
